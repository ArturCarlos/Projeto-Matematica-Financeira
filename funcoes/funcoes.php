...
function descontoSimples()
{
    ...
    if($tipoDesconto == 'com') {
        if ($nominal != null & $taxa != null & $tempo != null & $valDesc == null) { //valor descontado
            $valDesc = descontoSimplesC($nominal, $taxa1, $tempo1);
            echo "<h4>Valor Presente: " . $nominal . "</h4> ";
            echo "<h4>Taxa (" . $taxa_t . "): " . $taxa . "</h4> ";
            echo "<h4>Tempo (" . $tempo_t . "): " . $tempo . "</h4> ";
            echo "<h4>Desconto: ". $valDesc ."</h4> ";
            echo "<h3>Valor Futuro: " . valDesconto($valDesc, $nominal) . "</h3> ";
        } elseif ($nominal == null & $taxa != null & $tempo != null & $valDesc != null) { //valor nominal
            $nominal = descontoSimplesCn($valDesc, $taxa1, $tempo1);
            ...
            echo "<h4>Valor Presente: " . $nominal . "</h4> ";
            echo "<h4>Taxa (" . $taxa_t . "): " . descontoSimplesCtx($nominal, $valDesc, $tempo1) . "</h4> ";
            echo "<h4>Tempo (" . $tempo_t . "): " . $tempo . "</h4> ";
            echo "<h4>Desconto: ". $valDesc ."</h4> ";
            echo "<h3>Valor Futuro: " . valDesconto($valDesc, $nominal) . "</h3> ";
            ...
            echo "<h4>Valor Presente: " . $nominal . "</h4> ";
            echo "<h4>Taxa (" . $taxa_t . "): " . $taxa . "</h4> ";
            echo "<h4>Tempo (" . $tempo_t . "): " . descontoSimplesCtempo($nominal, $valDesc, $taxa1) . "</h4> ";
            echo "<h4>Desconto: ". $valDesc ."</h4> ";
            echo "<h3>Valor Futuro: " . valDesconto($valDesc, $nominal) . "</h3> ";
        }
    } elseif ($tipoDesconto == 'rac') {
        if ($nominal != null & $taxa != null & $tempo != null & $valDesc == null) { //valor descontado
            $valDesc = descontoSimplesR($nominal, $taxa1, $tempo1);
            echo "<h4>Valor Presente: " . $nominal . "</h4> ";
            echo "<h4>Taxa (" . $taxa_t . "): " . $taxa . "</h4> ";
            echo "<h4>Tempo (" . $tempo_t . "): " . $tempo . "</h4> ";
            echo "<h4>Desconto: ". $valDesc, $nominal ."</h4> ";
            echo "<h3>Valor Futuro: " . valDesconto($valDesc, $nominal) . "</h3> ";
        } elseif ($nominal == null & $taxa != null & $tempo != null & $valDesc != null) { //valor nominal
            $nominal = descontoSimplesRn($valDesc, $taxa1, $tempo1);
            echo "<h4>Valor Presente: " . $nominal . "</h4> ";
            echo "<h4>Taxa (" . $taxa_t . "): " . $taxa . "</h4> ";
            echo "<h4>Tempo (" . $tempo_t . "): " . $tempo . "</h4> ";
            echo "<h4>Desconto: ". $valDesc ."</h4> ";
            ...
            echo "<h4>Valor Presente: " . $nominal . "</h4> ";
            echo "<h4>Taxa (" . $taxa_t . "): " . descontoSimplesRtx($nominal, $valDesc, $tempo1) . "</h4> ";
            echo "<h4>Tempo (" . $tempo_t . "): " . $tempo . "</h4> ";
            echo "<h4>Desconto: ". $valDesc ."</h4> ";
            echo "<h3>Valor Futuro: " . valDesconto($valDesc, $nominal) . "</h3> ";
            ...
            echo "<h4>Valor Presente: " . $nominal . "</h4> ";
            echo "<h4>Taxa (" . $taxa_t . "): " . $taxa . "</h4> ";
            echo "<h4>Tempo (" . $tempo_t . "): " . descontoSimplesRtempo($nominal, $valDesc, $taxa1) . "</h4> ";
            echo "<h4>Desconto: ". $valDesc ."</h4> ";
            echo "<h3>Valor Futuro: " . valDesconto($valDesc, $nominal) . "</h3> ";
        }
    } else {
...
function valDesconto($valF, $valP) {
    $desconto = $valF + $valP;
    return $desconto;
}
...
function montante()
{
    // if (isset($_GET['tipo-juros'])) {
    //     $tipoJuros = $_GET['tipo-juros'];
    //     echo $_GET['tipo-juros'];
    // }
    if (isset($_GET['vp'])) {
        $vp = $_GET['vp'];
    } else {
